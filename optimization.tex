...
for which the minima are known, then iteratively improve their approximations.
...
consideration. They generally eliminate the same percentage of the space on each iteration.
