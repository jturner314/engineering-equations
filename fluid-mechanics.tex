...
\begin{table}
  ...
  mass, \(m\) & \(\mathsf{M}\) \\
  length, \(\ell\) & \(\mathsf{L}\) \\
  temperature, \(T\) & \(\mathsf{\Theta}\) \\
  time, \(t\) & \(\mathsf{T}\) \\
  velocity, \(V\) & \(\mathsf{L}/\mathsf{T}\) \\
  force, \(F\) & \(\mathsf{M}\mathsf{L}/\mathsf{T}^2\) \\
  energy, \(E\) & \(\mathsf{M}\mathsf{L}^2/\mathsf{T}^2\) \\
  pressure, \(p\) & \(\mathsf{M}/(\mathsf{L}\mathsf{T}^2)\) \\
  volume, \(\volsym\) & \(\mathsf{L}^3\) \\
  volume flow rate, \(Q\) & \(\mathsf{L}^3/\mathsf{T}\) \\
  density, \(\rho\) & \(\mathsf{M}/\mathsf{L}^3\) \\
  specific weight, \(\gamma\) & \(\mathsf{M}/(\mathsf{L}^2\mathsf{T}^2)\) \\
  dynamic viscosity, \(\mu\) & \(\mathsf{M}/(\mathsf{L}\mathsf{T})\) \\
  kinematic viscosity, \(\nu\) & \(\mathsf{L}^2/\mathsf{T}\) \\
  \bottomrule
  \end{tabu}}
  ~
  ...
  \midrule
  Reynolds number, \(\var{Re}\) & \(\frac{\textrm{inertia force}}{\textrm{viscous force}}\)
  & \(\frac{\rho{}V\ell}{\mu}\) \\
  Euler number, \(\var{Eu}\) & \(\frac{\textrm{pressure force}}{\textrm{inertia force}}\)
  & \(\frac{\Delta p}{\rho{}V^2}\) \\
  Froude number, \(\var{Fr}\) & \(\frac{\textrm{inertia force}}{\textrm{gravity force}}\)
  & \(\frac{V}{\sqrt{g\ell}}\) \\
  Mach number, \(\var{Ma}\) & \(\frac{\textrm{inertia force}}{\textrm{compressibility force}}\)
  & \(\frac{V}{c}\) \\
  Cauchy number, \(\var{Ca}\) & \(\frac{\textrm{inertia force}}{\textrm{compressibility force}}\)
  & \(\frac{\rho{}V^2}{E_v}\) \\
